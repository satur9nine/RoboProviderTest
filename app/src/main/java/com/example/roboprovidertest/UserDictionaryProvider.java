...
public class UserDictionaryProvider extends ContentProvider {
   ...
   *   Adds SHORTCUT (TEXT).
   */
  private static final String AUTHORITY = "com.example." + UserDictionary.AUTHORITY;
  ...
  /**
   * You shouldn't make this static but it works fine in real android apps.
   */
  ...
  /**
   * Robolectric doesn't invoke this, despite creating a new ContentProvider automatically for each test.
   */
  @Override
